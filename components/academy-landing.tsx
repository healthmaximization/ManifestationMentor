  ...
  return (
    <main className="academy-page">
      <header className="academy-nav">
        <Link href="/academy" className="academy-brand">
      ...
      <section className="academy-hero" aria-labelledby="academy-title">
        ...
        <p className="academy-kicker"><Headphones size={16} /> For subliminal listeners ready for a real system</p>
        <h1 id="academy-title">Why most people <span>do not get results</span> from subliminals, even when they listen daily.</h1>
        <p className="academy-hero-copy">Most people waste time listening without direction. Our step-by-step system shows you how to listen consistently, remove common roadblocks, and track what is actually changing.</p>
      ...
      <section className="academy-comment-section" aria-labelledby="comments-title">
        <div className="academy-section-heading centered">
          ...
          <h2 id="comments-title">Other listeners seem to move forward. <span>You are still waiting.</span></h2>
        </div>
      ...
      <section className="academy-problem">
        <div className="academy-problem-copy">
          ...
          <h2>You watch. You listen. You wait. <span>Nothing happens.</span></h2>
          <p>You start wondering whether something is wrong with you. You switch to another subliminal, then another, and still feel stuck.</p>
          <strong>It is not your fault.</strong>
          <p>Most listeners never get clear results because nobody showed them how to build a consistent process around what they are listening to.</p>
        </div>
        <div className="academy-mistakes">
          <h3>Why most listeners never see real change</h3>
      ...
      <section className="academy-system">
        <div className="academy-section-heading centered">
          ...
          <h2>We do not just give you affirmations. We give you the <span>system</span> that helps you use them effectively.</h2>
        </div>
      ...
      <section className="academy-testimonials">
        <div className="academy-section-heading">
          ...
          <h2>Clarity and accountability make consistency <span>much easier.</span></h2>
        </div>
      ...
      <section className="academy-final-cta">
        <BrandLogo />
        <h2>Join the community where subliminal listeners build a process for <span>real, consistent progress.</span></h2>
        <p>Get the courses, roadmaps, accountability, and support you need to stop guessing.</p>
